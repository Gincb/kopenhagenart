...
function handleData(eventEvents) {
    ...
    function changeDate() {
        var resultProductData = eventEvents.filter(function (a) {
            ...
            }); //make array of dates from database (event start and end array)
            ...
            var hitDateMatches = dates.filter(function (date) {
                var newDate = date.getFullYear() + "-" + date.getMonth() + "-" + date.getDate();
                var newStart = selectedDate.getFullYear() + "-" + selectedDate.getMonth() + "-" + selectedDate.getDate();
                return newDate.toString() == newStart.toString()
